...
public class Utilisateur
{
	...
	protected Set<Utilisateur> amis;
	 ...
	 * @ordered
	 */
	public void basicSetMoi(Utilisateur myMoi) {
		if (this.moi != myMoi) {
			if (myMoi != null){
				if (this.moi != myMoi) {
					Utilisateur oldmoi = this.moi;
					this.moi = myMoi;
					if (oldmoi != null)
						oldmoi.removeAmis(this);
				}
			}
		}	
	}
	...
	public Set<Utilisateur> getAmis() {
		if(this.amis == null) {
				this.amis = new HashSet<Utilisateur>();
		}
		return (Set<Utilisateur>) this.amis;	
	}
	 ...
	 * @ordered
	 */
	public void addAllAmis(Set<Utilisateur> newAmis) {
		if (this.amis == null) {
			this.amis = new HashSet<Utilisateur>();
		}
		for (Utilisateur tmp : newAmis)
			tmp.setMoi(this);
	 ...
	 * @ordered
	 */
	public void removeAllAmis(Set<Utilisateur> newAmis) {
		if(this.amis == null) {
			return;
		}
	 ...
	 * @ordered
	 */
	public void addAmis(Utilisateur newAmis) {
		if(this.amis == null) {
			this.amis = new HashSet<Utilisateur>();
		}
		
		if (this.amis.add(newAmis))
			newAmis.basicSetMoi(this);	
	}
	 ...
	 * @ordered
	 */
	public void setMoi(Utilisateur myMoi) {
		this.basicSetMoi(myMoi);
		myMoi.addAmis(this);	
	}
	 ...
	 * @ordered
	 */
	public void removeAmis(Utilisateur oldAmis) {
		if(this.amis == null)
			return;
		
		if (this.amis.remove(oldAmis))
			oldAmis.unsetMoi();
	...
	public void removeSeance(Seance oldSeance) {
		...
		if (this.seance.remove(oldSeance))
			oldSeance.removeUtilisateur(this);
